  ...
  return (
    ...
    >
      ...
      <div className="col-span-5 p-2">
        <div data-aos="flip-left" className="flex flex-col items-center lg:sticky lg:top-32">
          <img
            loading="lazy"
        ...
        <div className="p-6 md:p-10 border-b-[1px] border-t-[1px] rounded-[3rem] md:rounded-[4rem] custom-shadow bg-[#080810ab] backdrop-blur-md min-h-[550px] flex flex-col justify-between">
          <div>
            ...
            <div className="space-y-6 text-white mb-10">
              <p className="text-xl md:text-2xl lg:text-[26px]  text-gray-200">
              ...
              <p className="text-lg md:text-xl lg:text-[20px] text-gray-400 ">
            ...
            <div className="flex flex-wrap gap-3 mb-12">
              {tags.map((tag, i) => (
                <span
                  key={i}
                  className="px-4 py-2 rounded-full text-sm md:text-base font-medium bg-white/5 border border-white/10 text-gray-300 hover:text-white hover:border-purple-500/50 hover:bg-purple-500/10 transition-all cursor-default shadow-sm"
                >
                  {tag}
                </span>
              ))}
